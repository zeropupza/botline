...
const char* host = "https://botlinefeeder.herokuapp.com/bot.php";//change this to your linebot server ex.http://numpapick-linebot.herokuapp.com/bot.php
#define APPID   "botlinefeeder"     //change this to your APPID
#define KEY     "Rdevc7rR9enHouq"     //change this to your KEY
#define SECRET  "REOZ8LFanWY6fv0lLsOjMIfNd"     //change this to your SECRET
